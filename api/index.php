<?php
/**
 * api/index.php - Entry Point & Landing Page for Vercel Serverless
...
if (file_exists($view_file)) {
    ...
    if (file_exists($api_file)) {
        ...
        echo "<div style='padding:50px; text-align:center; font-family:sans-serif;'>
                ...
                <a href='" . BASE_URL . "/index.php' style='color:#10b981; font-weight:bold; text-decoration:none;'>Kembali ke Beranda</a>
              </div>";
    }
}
?>
